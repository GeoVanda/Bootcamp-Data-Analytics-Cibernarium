...
-- AHora sí se pudo modificar credit_card_id.id
...
SELECT t.id AS Transaction_ID , u.name AS User_Name , u.surname AS User_Surname, cc.iban AS IBAN, c.company_name AS Compañia
FROM transaction t 
